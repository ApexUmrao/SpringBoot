...
public class DataInitializer {
    ...
    public DataInitializer(SocialUserRepo userRepository, SocialGroupRepo groupRepository,
			SocialProfileRepo socialProfileRepository, PostRepo postRepository) {
    ...
    public CommandLineRunner initializeData() {
        return args -> {
            ...
            post1.setUserSocial(user1);
            post2.setUserSocial(user2);
            post3.setUserSocial(user3);
