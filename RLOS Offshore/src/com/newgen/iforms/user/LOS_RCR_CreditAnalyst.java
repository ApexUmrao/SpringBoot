...
Author                         : 
Group                          : AUB-RLOS
Project/Product                : Application -ProjectsApplication                    :
...
public class LOS_RCR_CreditAnalyst implements IFormServerEventHandler {
	...
	public String executeServerEvent(IFormReference ifr, String controlId, String eventType, String param) {
		...
		try {
			...
			if ("onClick".equals(eventType)) {
				...
				//Ajay 14Nov  Start
				LOS_EG.mLogger.info("Inside Click Control ID is : " + controlId);
				 if (controlId.equalsIgnoreCase("button193") || controlId.equalsIgnoreCase("button166")) {
